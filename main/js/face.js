...
site.Width = window.innerWidth;
site.Height = window.innerHeight;
...
Background.headparticle = function() {   
   ...
   var particlehead = document.querySelector('.particlehead');
   particlehead.appendChild(Background.renderer.domElement);
   particlehead.addEventListener('mousemove', onDocumentMouseMove);
