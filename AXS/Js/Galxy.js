...
renderer.setAnimationLoop(() => {
    galaxy.rotation.y += 0.015; // Adjust the value to control the rotation speed
    universe.rotation.y = galaxy.rotation.y / 3; // Apply a relative rotation to the universe
    
    // galaxyMaterial.uniforms.uTime.value += 0.001; // Optionally, you can increase uTime for animation effects
